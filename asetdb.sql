...
CREATE TABLE
	IF NOT EXISTS "lokasi" (
		"lokasiid" BIGSERIAL NOT NULL,
...
DROP TABLE IF EXISTS "asetmove";

CREATE TABLE
	IF NOT EXISTS "asetmove" (
		"asetmoveid" BIGSERIAL NOT NULL,
...
-- Dumping data for table public.asetmove: -1 rows
DELETE FROM "asetmove";
